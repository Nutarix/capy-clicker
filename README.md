...
- При 100%: спавн +1 капибары (до 8), overflow переносится
- Несколько капибар на лугу с уровнями и разными позициями
- Drag-merge одинакового уровня → Lv+1 (крупнее визуально)
- Камера: zoom-out в 3 шага (1–2 / 3–5 / 6+)
...
lib/
  ...
  features/game/
    ...
    widgets/         # meadow, flowers, capy, mud, berry, progress
docs/
  BALANCE_V0.md
```
...
Пиксель-спрайты, звук, daily rewards, IAP, Flame (по необходимости).
